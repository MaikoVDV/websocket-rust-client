...
pub async fn broadcast_game_input(
    mut input_receiver: watch::Receiver<GameInput>,
    ...
    info!("Websocket broadcaster thread created. Entering loop and sending inputs at {} tps", input_send_interval);
    let mut interval = tokio::time::interval(time::Duration::from_millis(1000 / input_send_interval));
    loop {
