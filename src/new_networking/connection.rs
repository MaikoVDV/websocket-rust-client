...
pub fn handle_connection_event(
    ...
    let network_event_sender = ws_client.connection_events.sender.clone();
    let network_event_sender_two = ws_client.connection_events.sender.clone();
    ...
    ws_client.server_connection = Some(ServerConnection {
        ...
        listen_task: ws_client.runtime.spawn(async move {
            let mut read_socket = read_socket; // Object to listen to
